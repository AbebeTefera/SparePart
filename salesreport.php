	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Sales Report</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
			<form class="form-horizontal" action="php_action/fetchSalesReportPrint.php" method="post" id="getOrderReportForm">
...
<script src="custom/js/salesReport.js"></script>
