	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal" action="php_action/fetchPurchaseDetailReportPrint.php" method="post" id="getOrderReportForm">
				  <div class="form-group">
					...
					<div class="col-sm-2">
				     <!-- <button type="button" class="btn btn-success" id="exportToExcel" name="exportToExcel"> <i class="fa fa-download"></i> Export to Excel</button>-->
				    </div>
				  </div>
				</form>
...
<script src="custom/js/purchasedetailReport.js"></script>
