...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			var criticalLimit = $("#criticalLimit").val();
			var unit = $("#unit").val();
			...
			if(description == "") {
				...
				$('#descripiton').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
			...
			if(model == "") {
				$("#model").after('<p class="text-danger">Model field is required</p>');
				$('#model').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#model").find('.text-danger').remove();
				// success out for form 
				$("#model").closest('.form-group').addClass('has-success');	  	
			}	// /else
			...
			if(criticalLimit == "") {
				$("#criticalLimit").after('<p class="text-danger">Critical Limit field is required</p>');
				$('#criticalLimit').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#criticalLimit").find('.text-danger').remove();
				// success out for form 
				$("#criticalLimit").closest('.form-group').addClass('has-success');	  	
			}
			if(shelfNo == "") {
				$("#shelfNo").after('<p class="text-danger">Shelf No field is required</p>');
				$('#shelfNo').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#shelfNo").find('.text-danger').remove();
				// success out for form 
				$("#shelfNo").closest('.form-group').addClass('has-success');	  	
			}
			if(unit == "") {
				$("#unit").after('<p class="text-danger">Stock Unit field is required</p>');
			...
			if(productImage && partNo && description && model && unit && criticalLimit && shelfNo && brandName && categoryName && productStatus) {
	...
	if(productId) {
		...
		$.ajax({
			...
			// alert(response.product_image);
				...
				$("#getProductImage").attr('src', 'stock/'+response.part_image);
				...
				// part no
				$("#editPartNo").val(response.part_no);
				// Description
				...
				$("#editCriticalLimit").val(response.critical_limit);
				$("#editUnit").val(response.stock_unit_id);
				$("#editShelfNo").val(response.shelf_id);
				// status
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
						...
						var criticalLimit = $("#editCriticalLimit").val();
						var unit = $("#editUnit").val();
						var shelfNo = $("#editShelfNo").val();
						...
						if(description == "") {
							...
							$('#editDescripiton').closest('.form-group').addClass('has-error');
						}	else {
							// remov error text field
						...
						if(criticalLimit == "") {
							$("#editCriticalLimit").after('<p class="text-danger">Critical Limit field is required</p>');
							$('#editCriticalLimit').closest('.form-group').addClass('has-error');
						}	else {
							// remov error text field
							$("#editCriticalLimit").find('.text-danger').remove();
							// success out for form 
							$("#editCriticalLimit").closest('.form-group').addClass('has-success');	  	
						}
						if(shelfNo == "") {
							$("#editShelfNo").after('<p class="text-danger">Shelf No field is required</p>');
							$('#editShelfNo').closest('.form-group').addClass('has-error');
						}	else {
							// remov error text field
							$("#editShelfNo").find('.text-danger').remove();
							// success out for form 
							$("#editShelfNo").closest('.form-group').addClass('has-success');	  	
						}
						if(unit == "") {
							$("#editUnit").after('<p class="text-danger">Stock Unit field is required</p>');
