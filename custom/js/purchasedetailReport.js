...
$('#navPurchaseDetailReport').addClass('active');

		managePurchaseTable = $("#managePurchaseTable").DataTable({
			'ajax': 'php_action/fetchPurchasedetailReport.php',
			'order': []
		});
// order date picker
			...
			$.ajax({
				...
				success:function(response) {
					...
					var mywindow = window.open('', 'Stock Management System', 'height=400,width=600');
						mywindow.document.write('<html><head><title>Purchase Detail Report </title>');        
