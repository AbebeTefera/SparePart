	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	   <!-- <li><a type="button" data-toggle="modal" data-target="#editSRModel" onclick="editSRAcc('.$srId.')"> <i class="glyphicon glyphicon-edit"></i> Detail</a></li>-->
		<li><a type="button" data-toggle="modal" data-target="#editSRModel" onclick="editSRAcc('.$srId.')"> <i class="glyphicon glyphicon-edit"></i> Acceptance</a></li>
		<li><a type="button" onclick="printSIV('.$srId.')"> <i class="glyphicon glyphicon-edit"></i> Print SIV</a></li>
