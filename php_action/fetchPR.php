 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a type="button" data-toggle="modal" data-target="#editPRModel" onclick="editPRs('.$prId.')"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
	    <li><a type="button" data-toggle="modal" data-target="#removeMemberModal" onclick="removePRs('.$prId.')"> <i class="glyphicon glyphicon-trash"></i> Remove</a></li>       
	  </ul>
	</div>';
